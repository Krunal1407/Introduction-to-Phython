...
--- 7.	Display the employee last name and employee number along with their managers last name and manager number
...
--- 	Label the columns as Employee name, emp _hire_ date,manager name,man _hire_ date.
SELECT 
